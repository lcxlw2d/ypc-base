...
import {getClientAgencyStockList} from '../../../actions/client/summary/transactionAction';

import styles from '../../css/client/detail/profitList.css';

//交易 - 委托 - 股票
class TradeAgencyStockList extends CursorTable {
    ...
    getData(startIndex, isAppend, cb, props) {
        ...
        this.props.getClientAgencyStockList(params, isAppend, cb, this, this.updateList);
    }
...
function injectAction() {
    return {getClientAgencyStockList};
}

module.exports = connect(injectProps, injectAction(),null,{withRef:true})(TradeAgencyStockList);
